...
export default {
    ...
    exerciseTraining,
    noSummary,
    leftFootText: { eng: 'Left Foot', thai: 'เท้าซ้าย' },
    rightFootText: { eng: 'Right Foot', thai: 'เท้าขวา' },
    pressurePercentageText: { eng: 'Pressure Percentage', thai: 'เปอร์เซ็นต์แรงกด' },
    footBalanceText: { eng: 'Foot Balance', thai: 'สมดุลเท้า' },
    pathSwayText: { eng: 'Path Sway', thai: 'การแกว่งของเส้นทาง' },
    mlSwayText: { eng: 'ML Sway', thai: 'การแกว่งด้านข้าง' },
    apSwayText: { eng: 'AP Sway', thai: 'การแกว่งหน้า-หลัง' },
    ellipseAreaText: { eng: 'Ellipse Area', thai: 'พื้นที่วงรี' },
    velocityText: { eng: 'Velocity', thai: 'ความเร็ว' },
    cadenceText: { eng: 'Cadence', thai: 'จังหวะก้าว' },
    stepCountText: { eng: 'Step Count', thai: 'จำนวนก้าว' },
    gaitSpeedText: { eng: 'Gait Speed', thai: 'ความเร็วการเดิน' },
    leftText: { eng: 'Left', thai: 'ซ้าย' },
    rightText: { eng: 'Right', thai: 'ขวา' },
};
